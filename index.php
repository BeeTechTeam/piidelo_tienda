            ...
            <ul class="collapsible" style="box-shadow: unset; border: unset;">
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        ...
                        <ul>
                            <li>El cambio del producto idéntico (sujeto a disponibilidad de stock en la página).</li>
                            <li>
                                En caso de ser una devolución por los siguientes motivos:
                                <ul>
                            ...
                            <li>PIIDELO procederá con el reembolso o emitirá una nota de crédito dicho importe de acuerdo a la confirmación del cliente.</li>
                            <li>Para poder ejercer el derecho de devolución o cambio el cliente deberá cumplir con las condiciones generales (Ver punto 10.1) y Consideraciones (Ver punto 10.2).</li>
                        </ul>
                        </p>
                        <p> La devolución de dinero (de acuerdo al método de pago utilizado. Ver política de reembolsos). </p>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        ...
                        <p> Teniendo en cuenta esta resolución, es obligación del consumidor decidir correctamente el documento que solicitará como comprobante al momento de su compra, ya que según los párrafos citados no procederá cambio alguno.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        ...
                        <p> Para una compra con tarjeta de crédito, débito o métodos que permitan la devolución del dinero a través de una cuenta asociada, se hará el reverso a la tarjeta o a la cuenta asociada por el total pagado.</p>
                        <p> Para una compra a través de una transferencia, depósito bancario o pagos en efectivo, se hará una transferencia por el total pagado a cuenta bancaria del titular de la compra.</p>
                        <p> Tiempos de ejecución: El tiempo de ejecución del reembolso es de hasta un (1) día hábil.</p>
                        <p> Tiempos de procesamiento: Reverso a la tarjeta: El tiempo del reembolso a una tarjeta puede ser hasta quince (15) días hábiles, el tiempo de procesamiento es responsabilidad de la entidad financiera que emitió la tarjeta y es contado desde la ejecución del reembolso.</p>
                        <p> Transferencia bancaria: Para recibir el dinero en una cuenta bancaria, el titular de la cuenta debe ser el mismo que realizó la compra en PIIDELO. El tiempo de procesamiento es de tres (3) días hábiles desde su ejecución. La información bancaria proporcionada por el cliente debe ser correcta para evitar retrasos en la atención. De no ser así los tiempos de ejecución y procesamiento se prolongarán.</p>
                        <p>
                            Los datos necesarios son:
                        <ul>
                            <li>Nombre y apellido</li>
                            <li>Documento de Identidad</li>
                            <li>Número de orden y/o detalle del producto</li>
                            <li>Correo electrónico registrado en PIIDELO</li>
                            <li>Datos de la cuenta bancaria</li>
                        </ul>
                        *Tomar en cuenta que algunas cajas rurales y municipales la transacción del depósito se concretará bajo disposición de la misma Entidad financiera. Para mayor información sobre la aceptación de depósitos externos a estas cuentas, deberá contactar con dicha Entidad.
                        </p>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Todo el contenido incluido o puesto a disposición del Usuario en el Sitio, incluyendo textos, gráficas, logos, íconos, imágenes, archivos de audio, descargas digitales y cualquier otra información (el "Contenido"), es de propiedad de Seven Corpsolutions S.A.C. o ha sido licenciada a ésta por las Empresas Proveedoras. La compilación del Contenido es propiedad exclusiva de Seven Corpsolutions S.A.C. y, en tal sentido, el Usuario debe abstenerse de extraer y/o reutilizar partes del Contenido sin el consentimiento previo y expreso de la Empresa.</p>
                        <p> Además del Contenido, las marcas, denominativas o figurativas, marcas de servicio, diseños industriales y cualquier otro elemento de propiedad intelectual que haga parte del Contenido (la "Propiedad Industrial"), son de propiedad de Seven Corpsolutions S.A.C. o de las Empresas Proveedoras y, por tal razón, están protegidas por las leyes y los tratados internacionales de derecho de autor, marcas, patentes, modelos y diseños industriales. El uso indebido y la reproducción total o parcial de dichos contenidos quedan prohibidos, salvo autorización expresa y por escrito de Seven Corpsolutions S.A.C., asimismo, no pueden ser usadas por los Usuarios en conexión con cualquier producto o servicio que no sea provisto por Seven Corpsolutions S.A.C. En el mismo sentido, la Propiedad Industrial no podrá ser usada por los Usuarios en conexión con cualquier producto y servicio que no sea de aquellos que comercializa u ofrece Seven Corpsolutions S.A.C. o de forma que produzca confusión con sus clientes o que desacredite a la Empresa o a las Empresas Proveedoras.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> PIIDELO es una empresa respetuosa de las leyes y no pretende aprovecharse de la reputación de terceros, apropiándose de la propiedad intelectual por ellos protegida. Por lo anterior contamos con herramientas que buscan asegurar que productos que se adquieran a través de nuestra página sean originales y/o de sus mismos productores. Teniendo en cuenta lo anterior, si usted sospecha que algún producto que se encuentra en nuestra página infringe derecho de propiedad intelectual de terceros o infringe derechos legalmente protegido por usted, agradecemos notificárnoslo para bajar dichos productos inmediatamente de nuestra página e iniciar todas las acciones tendientes a evitar que esto siga sucediendo.</p>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Este acuerdo será gobernado e interpretado de acuerdo con las leyes de Perú, sin dar efecto a cualquier principio de conflictos de ley. Si alguna disposición de estos Términos y Condiciones es declarada ilegal, o presenta un vacío, o por cualquier razón resulta inaplicable, la misma deberá ser interpretada dentro del marco del mismo y en cualquier caso no afectará la validez y la aplicabilidad de las provisiones restantes.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Cualquier comentario, inquietud o reclamación respecto de los anteriores Términos y Condiciones, la Política de Privacidad, o la ejecución de cualquiera de éstos, deberá ser notificada por escrito a Seven Corpsolutions S.A.C. a la siguiente dirección: Calle Juan del Carpio 286 Of. 101 - Lima - San Isidro</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Este acuerdo estará regido en todos sus puntos por las leyes vigentes en la República del Perú.</p>
                        <p> Cualquier controversia derivada del presente acuerdo, su existencia, validez, interpretación, alcance o cumplimiento, será sometida a los tribunales competentes de la ciudad de Lima, Perú.</p>
                    </div>
                </li>
                <li>
        ...
        <div class="modal-content">
            <ul class="collapsible" style="box-shadow: unset; border: unset;">
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Seven Corpsolutions S.A.C. tiene un firme compromiso por el respeto y el cumplimiento de todas las disposiciones legales y reglamentarias que les son aplicables. Asimismo, entiende que los datos personales, al ser parte integrante de la privacidad de las personas; y al ser, también, fundamentales para nuestra actividad, deben ser tratados de tal forma que no sólo impliquen el cumplimiento del ordenamiento legal, sino que, además, se deben tomar medidas que generen un ambiente de confianza y seguridad en el público respecto a dicho tratamiento.</p>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> La presente Política se aplica a toda actividad de tratamiento de datos personales realizada por parte de Seven Corpsolutions S.A.C. (en adelante “PIIDELO”). Será también de aplicación para aquellas personas o empresas a las que PIIDELO requiera el tratamiento de datos personales de los cuales sea responsable.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Los términos que en esta política se usan con mayúscula se encuentran definidos en el Anexo N°1.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p>
                            PIIDELO se compromete a respetar los principios rectores establecidos en la Normativa de Protección de Datos Personales. Estos son:
                        <ul>
                            ...
                            <li>Principio de finalidad: Los datos personales deben ser recopilados para una finalidad determinada, explícita y lícita, y su tratamiento no debe extenderse a otra finalidad distinta a aquella para la cual fueron recopilados.</li>
                            ...
                            <li>Principio de seguridad: El titular del banco de datos personales y el Encargado del banco de datos personales deben adoptar las medidas técnicas, organizativas y legales necesarias para garantizar la seguridad de los datos personales.</li>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> PIIDELO realiza tratamiento de datos personales de colaboradores, clientes y potenciales clientes, proveedores, empleados y demás personas que conforman sus públicos de interés, de conformidad con las finalidades autorizadas por cada uno de ellos en los consentimientos que han otorgado a PIIDELO, con las excepciones al requisito de obtención del consentimiento previstas por la Normativa de Protección de Datos Personales.</p>
                        <p>
                            PIIDELO informa que tratará los datos personales, entre otras, para las siguientes finalidades de carácter general:
                        <ul>
                            <li>Para cumplir con las obligaciones generadas por los vínculos contractuales y no contractuales generados con el titular de datos personales.</li>
                            <li>Comunicar a sus públicos de interés información comercial sobre su actividad empresarial, sus bienes y servicios, según el consentimiento que se obtenga del Titular de datos personales.</li>
                            <li>Cumplir con sus obligaciones legales como empleador.</li>
                            <li>Hacer seguimiento y monitoreo con fines de gestión de riesgos de seguridad a través de sus dispositivos de video-vigilancia, de registro biométrico, y otros que se dispongan.</li>
                            <li>Llevar a cabo actividades de debida diligencia y gestión de riesgos empresariales.</li>
                            <li>Suministrar los Datos Personales a terceros, en Perú o en el exterior, con los cuales PIIDELO tenga relación contractual y que sea necesario entregársela para el cumplimiento del objeto contratado. Por ejemplo, PIIDELO puede utilizar terceros para que le ayuden con la entrega de promoción de productos, recaudar sus pagos, enviar productos u operar nuestros sistemas de servicio al cliente.</li>
                            <li>Completar automáticamente los documentos asociados a las transacciones que realice el Titular en función de los productos adquiridos y/o servicios utilizados o</li>
                            <li>Desarrollar acciones comerciales o servicios post venta, de carácter general o dirigidas personalmente al Titular, tendientes a mejorar su experiencia como cliente a través de los Canales de Comunicación.</li>
                            <li>Mantener informado, a través de los Canales de Comunicación, al Titular de Datos Personales sobre el proceso de entrega y estado de los pedidos realizados.</li>
                        </ul>
                        </p>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> PIIDELO puede encargar todo o parte del tratamiento de datos personales contenidos en los bancos de datos personales de los cuales es titular, a proveedores legítimos para el cumplimiento de sus actividades empresariales, que se encuentren en el Perú o en el extranjero.</p>
                        <p> Cuando PIIDELO encargue el tratamiento de un banco de datos para la prestación de algún servicio específico a terceros contratados con posterioridad a la publicación de la presente política, cumplirá con las exigencias establecidas para los encargados de tratamiento en la Normativa de Protección de Datos Personales.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> PIIDELO requerirá del consentimiento libre, previo, expreso, inequívoco e informado del titular de los datos personales para el tratamiento de los mismos, salvo en los casos de excepción expresamente establecidos por la Normativa de Protección de Datos Personales.</p>
                        <p> PIIDELO no requerirá consentimiento para tratar sus datos personales obtenidos de fuentes accesibles al público, gratuitas o no, para el uso por el cual dichas fueron hechas accesibles al público; así mismo, podrá tratar sus datos personales de fuentes no públicas, siempre que dichas fuentes cuenten con su consentimiento para tratar y transferir dichos datos personales.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> En los casos en los que el titular de los datos lo haya autorizado expresamente, PIIDELO podrá transferir local e internacionalmente los datos personales a sus empresas relacionadas, y a sus aliados comerciales, para enviarle publicidad, realizar encuestas, invitaciones a eventos, conocer sus preferencias de consumo, elaborar estadísticas y/o estudios de comportamiento, evaluar su capacidad de endeudamiento, comportamiento de pago de consumo y patrimonio.</p>
                        <p> Seven Corpsolutions S.A.C. también transfiere al exterior datos personales a terceros encargados de tratamiento, entre ellos a la empresa encargada de brindar los servicios de Host de la página web.</p>
                        <p> Asimismo, PIIDELO podrá transferir datos personales a entidades públicas legalmente facultadas dentro del ámbito de sus competencias, en cumplimiento de normativa vigente o futura, o por requerimiento de éstas, o cuando medie alguna de las excepciones previstas en la ley.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        ...
                        <ul>
                            ...
                            <li> 5. Derecho de Oposición: El titular de datos personales puede oponerse al tratamiento de sus datos personales en cualquier momento. La oposición procederá en la medida que el tratamiento no tenga justificación contractual o legal.</li>
                            <li> 6. Derecho de revocación: El titular de datos personales puede retirar en cualquier momento el consentimiento otorgado de manera previa. La revocación no alcanzará a los usos y/o tratamientos que puedan ejecutarse en los escenarios autorizados por la regulación.</li>
                            ...
                            <li> 9. Derecho a ser indemnizado: El titular de datos personales que sea afectado a consecuencia del incumplimiento de la presente Ley por el titular o por el encargado del banco de datos personales o por terceros, tiene derecho a obtener la indemnización correspondiente, conforme a ley.</li>
                        </ul>
                        </p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Los Titulares podrán revocar su consentimiento o ejercer sus derechos de Ley, dirigiéndose al correo hola@piidelo.com indicando su nombre completo, DNI y adjuntando copia de dicho DNI.</p>
                        <p> En caso que el titular del dato personal requiera ejercer sus derechos mediante un representante, éste deberá enviar una carta poder legalizada por notario público que lo faculte como tal y su documento de identidad.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p>Los datos personales tratados por PIIDELO serán almacenados por el tiempo necesario para cumplir las finalidades de tratamiento autorizadas por el titular, sin perjuicio de que este pueda ejercer en cualquier momento los derechos mencionados en el numeral X de esta política.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> En cumplimiento de la normativa vigente, PIIDELO adopta las medidas jurídicas, organizativas y técnicas apropiadas para garantizar la seguridad de los datos personales, evitando su alteración, pérdida, tratamiento indebido o acceso no autorizado.</p>
                        ...
                        <p> PIIDELO sólo realizará tratamiento sobre datos personales que estén almacenados en repositorios que reúnan las condiciones de seguridad exigidas por la normativa vigente en protección de datos personales.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> En PIIDELO usamos cookies y tecnologías similares para personalizar y mejorar su experiencia de cliente y para mostrarle publicidad online relevante. Las cookies son pequeños archivos de texto que contienen un identificador único que se almacena en el computador o aparato móvil a través del cual usted accede al Sitio, de manera que aquellos pueden ser reconocidos cada vez que usa el Sitio.</p>
                        <p> Usted puede deshabilitar el uso de cookies según la configuración de su navegador. Al respecto puede consultarnos en el correo hola@piidelo.com Tenga en cuenta que existen algunas cookies técnicas que al deshabilitarse podrían incluso impedir el funcionamiento correcto del sitio web.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> De producirse cualquier cambio o modificación de la presente Política, el texto vigente de la misma será publicado en nuestro portal web: https://www.piidelo.com en la sección Política de Privacidad.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        <p> Como parte de nuestra actividad, tratamos datos personales en cumplimiento con lo dispuesto en la Normativa de Protección de Datos Personales.</p>
                ...
                <li>
                    ...
                    <div class="collapsible-body" style="box-shadow: unset; border: unset; padding: unset;">
                        ...
                        <ul>
                            <li> Ley de Protección de Datos Personales: Ley 29733 y sus modificatorias.</li>
                            <li> Reglamento de la Ley de Protección de Datos Personales: Decreto Supremo N° 003-2013-JUS y sus modificatorias.</li>
                            <li> Banco de datos personales: Conjunto organizado de datos personales, automatizado o no, independientemente del soporte, sea este físico, magnético, digital, óptico u otros que se creen, cualquiera fuere la forma o modalidad de su creación, formación, almacenamiento, organización y acceso.</li>
                            <li> Datos sensibles: Datos personales constituidos por los datos biométricos que por sí mismo pueden identificar al titular, datos referidos al origen racial y étnico; ingresos económicos, opiniones o convicciones políticas, religiosas, filosóficas o morales; afiliación sindical; e información relacionada a la salud o a la vida sexual.</li>
                            <li> Encargado del banco de datos personales: Toda persona natural, persona jurídica de derecho privado o entidad pública que sola o actuando conjuntamente con otra realiza el tratamiento de los datos personales por encargo del titular del banco de datos personales.</li>
                            <li> Normativa de Protección de Datos Personales: Se refiere la Ley de Protección de Datos Personales. Al Reglamento de la Ley de Protección de Datos Personales y a sus modificatorias y normas complementarias.</li>
                            <li> Titular de datos personales: Persona natural a quien corresponde los datos personales.</li>
                            <li> Titular del banco de datos personales: Persona natural, persona jurídica de derecho privado o entidad pública que determina la finalidad y contenido del banco de datos personales, el tratamiento de estos y las medidas de seguridad.</li>
                            <li> Transferencia de datos personales: Toda transmisión, suministro o manifestación de datos personales, de carácter nacional o internacional, a una persona jurídica de derecho privado, a una entidad pública o a una persona natural distinta del titular de datos personales.</li>
                            ...
                            <li> Solicitud de ejercicio de Derecho ARCO: Es el pedido de acceso, rectificación, actualización, inclusión, cancelación, supresión u oposición, que formula el titular de datos personales respecto a su información.</li>
                            <li> Consentimiento del interesado: es toda manifestación de voluntad libre, especifica, informada e inequívoca por la que el interesado acepta, ya sea mediante una declaración o una clara acción afirmativa, el tratamiento de datos personales que le conciernen.</li>
                            <li> Canales de Comunicación: Correo físico, correo electrónico, mensajes de texto (SMS y/o MMS), medios digitales tales como Facebook, o "WhatsApp" u otras plataformas similares, número de celular o cualquier medio de comunicación que el Titular de Datos Personales proporcione a PIIDELO.</li>
                        </ul>
                        </p>
                    </div>
                </li>
